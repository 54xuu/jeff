...
export function registerAdminTools(reg: ToolBridge, deps: AdminDeps): void {
  ...
  reg.register(T_CREATE, async (args: { name?: string; description?: string; instructions?: string; avatar?: string; model_provider?: string; model_id?: string }) => {
  ...
  reg.register(T_UPDATE, async (args: { id?: string; name?: string; description?: string; instructions?: string; avatar?: string; model_provider?: string; model_id?: string; archived?: boolean }) => {
